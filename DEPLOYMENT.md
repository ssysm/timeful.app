> **Self-hosted fork:** Use [DOCKER.md](DOCKER.md) and the root `.env.example` for this branch. Both Compose filenames run the existing nginx/frontend/backend/mongodb stack. The upstream instructions below describe a different deployment layout.
